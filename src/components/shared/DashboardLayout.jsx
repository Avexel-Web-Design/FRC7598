      ...
      <div className="md:hidden flex flex-col h-full">
        ...
        <div className="bg-black border-b border-gray-700 px-4 py-3 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <img src="/Logo.svg" alt="FRC 7598 Logo" className="w-8 h-8" />
            <h1 className="text-white text-xl font-semibold">FRC 7598</h1>
          </div>
          <button
            onClick={() => setIsMobileMenuOpen(true)}
            className="text-white hover:text-sca-purple p-2 rounded-lg hover:bg-gray-800 transition-colors"
