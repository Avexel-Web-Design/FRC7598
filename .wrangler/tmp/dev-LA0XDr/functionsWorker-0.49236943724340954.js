...
// .wrangler/tmp/bundle-2JPvwH/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-QbgBzy/functionsWorker-0.49236943724340954.mjs
  ...
  route(path, app4) {
    ...
    app4.routes.map((r) => {
      ...
      if (app4.errorHandler === errorHandler) {
        ...
        handler = /* @__PURE__ */ __name2(async (c, next) => (await compose([], app4.errorHandler)(c, () => r.handler(c, next))).res, "handler");
...
var handle = /* @__PURE__ */ __name2((app4) => (eventContext) => {
  return app4.fetch(
...
var JwtAlgorithmNotImplemented = /* @__PURE__ */ __name2(class extends Error {
  constructor(alg) {
    super(`${alg} is not an implemented algorithm`);
    this.name = "JwtAlgorithmNotImplemented";
  }
}, "JwtAlgorithmNotImplemented");
var JwtTokenInvalid = /* @__PURE__ */ __name2(class extends Error {
  constructor(token) {
    super(`invalid JWT token: ${token}`);
    this.name = "JwtTokenInvalid";
  }
}, "JwtTokenInvalid");
var JwtTokenNotBefore = /* @__PURE__ */ __name2(class extends Error {
  constructor(token) {
    super(`token (${token}) is being used before it's valid`);
    this.name = "JwtTokenNotBefore";
  }
}, "JwtTokenNotBefore");
var JwtTokenExpired = /* @__PURE__ */ __name2(class extends Error {
  constructor(token) {
    super(`token (${token}) expired`);
    this.name = "JwtTokenExpired";
  }
}, "JwtTokenExpired");
var JwtTokenIssuedAt = /* @__PURE__ */ __name2(class extends Error {
...
var JwtTokenIssuer = /* @__PURE__ */ __name2(class extends Error {
  constructor(expected, iss) {
    super(`expected issuer "${expected}", got ${iss ? `"${iss}"` : "none"} `);
    this.name = "JwtTokenIssuer";
  }
}, "JwtTokenIssuer");
var JwtHeaderInvalid = /* @__PURE__ */ __name2(class extends Error {
  constructor(header) {
    super(`jwt header is invalid: ${JSON.stringify(header)}`);
    this.name = "JwtHeaderInvalid";
  }
}, "JwtHeaderInvalid");
var JwtHeaderRequiresKid = /* @__PURE__ */ __name2(class extends Error {
  constructor(header) {
    super(`required "kid" in jwt header: ${JSON.stringify(header)}`);
    this.name = "JwtHeaderRequiresKid";
  }
}, "JwtHeaderRequiresKid");
var JwtTokenSignatureMismatched = /* @__PURE__ */ __name2(class extends Error {
  constructor(token) {
...
__name2(getDMMessages, "getDMMessages");
...
__name2(sendDMMessage, "sendDMMessage");
...
__name2(updateChannel, "updateChannel");
...
__name2(deleteChannel, "deleteChannel");
...
__name2(markChannelAsRead, "markChannelAsRead");
...
__name2(getAllNotificationData, "getAllNotificationData");
...
__name2(getUnreadCounts, "getUnreadCounts");
...
__name2(getRecentDMUsers, "getRecentDMUsers");
var chat = new Hono2();
...
__name(getAuthUser2, "getAuthUser2");
__name2(getAuthUser2, "getAuthUser");
...
__name2(generateRecurringInstances, "generateRecurringInstances");
...
__name2(isValidOccurrence, "isValidOccurrence");
...
__name2(getNextOccurrence, "getNextOccurrence");
...
__name(getAuthUser3, "getAuthUser3");
__name2(getAuthUser3, "getAuthUser");
tasks.get("/", async (c) => {
  try {
...
__name(getAuthUser4, "getAuthUser4");
__name2(getAuthUser4, "getAuthUser");
...
__name2(getAuthUserId, "getAuthUserId");
...
// .wrangler/tmp/bundle-2JPvwH/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-2JPvwH/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.49236943724340954.js.map
